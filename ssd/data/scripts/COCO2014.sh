...
unzip ../test_img/train2014.zip -d ../test_img
echo "Extracting val images ..."
unzip ../test_img/val2014.zip -d ../test_img
echo "Extracting annotations ..."
unzip ./annotations_trainval2014.zip

echo "Removing zip files ..."
rm ../test_img/train2014.zip
rm ../test_img/val2014.zip
...
mkdir ../test_img/trainval35k
cd ../test_img/train2014
